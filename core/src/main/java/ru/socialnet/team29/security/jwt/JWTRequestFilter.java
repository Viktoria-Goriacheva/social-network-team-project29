        ...
        if (cookies != null) {
            for (Cookie cookie : cookies) {
                ...
                if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                    log.info(username +  " input through " + this.getClass().getSimpleName());
                    CoreUserDetails userDetails = (CoreUserDetails) coreUserDetailsService.loadUserByUsername(username);
