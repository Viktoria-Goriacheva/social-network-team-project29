  ...
  <div class="form-layout">
    <div class="form-layout__info" :style="styleInfo">
      <div class="form-layout__container">
        <form-layout-info></form-layout-info>
        <form-layout-footer></form-layout-footer>
      </div>
      <form-layout-language ref="language"></form-layout-language>
    </div>
      ...
      return this.getStatusOpenBlock
        ? {
            transform: `translateY(-${
              this.$refs.language.$refs.language.scrollHeight + 20
            }px)`,
          }
        : null;
    },
