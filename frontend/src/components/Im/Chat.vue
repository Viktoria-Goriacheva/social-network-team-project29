    ...
    <div class="im-chat__infitite_list_wrapper">
      ...
      >
        <div class="im-chat__loader" slot="header" v-show="fetching">
          <div class="spinner" v-show="!isHistoryEndReached()"></div>
...
export default {
  ...
  computed: {
    messagesGrouped() {
      ...
      for (const msg of this.messages) {
        ...
        msg.isSentByMe = +msg.author_id === +this.getInfo().id;
        groups.push(msg);
      }
      return groups;
    },
  ...
  methods: {
    ...
    onSubmitMessage() {
      ...
      const payload = {
        ...
        data: {
          ...
          recipient_id: this.info.conversationPartner.id,
          time,
        },
      };
      console.log(payload);
    ...
    setVirtualListToBottom() {
      console.log("setVirtualListToBottom");
      if (this.$refs.vsl) {
        console.log("if (this.$refs.vsl) ");
