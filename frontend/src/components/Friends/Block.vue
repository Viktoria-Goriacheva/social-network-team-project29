<template>
  <div class="friends-block">
    <div class="friends-block__img">
      ...
      <img v-else src="/static/img/avatar.png" :alt="info.first_name" />
    </div>
    <div class="friends-block__info">
      ...
      <span
        ...
        v-else-if="info.birth_date && info.country"
      >
        {{ info.birth_date | moment("from", true) }},
    ...
    <div class="friends-block__actions">
      <template v-if="moderator">
        ...
        >
          <simple-svg :filepath="'/static/img/delete.svg'"></simple-svg>
        </div>
      </template>
      <template v-else-if="admin">
        <div
          ...
          v-if="blocked || info.is_blocked"
        >
          <simple-svg
            class="filter-green"
            :filepath="'/static/img/security-system-unlock.svg'"
          ></simple-svg>
        </div>
        <div
          class="friends-block__actions-block"
          ...
          v-else
        >
          <simple-svg :filepath="'/static/img/unblocked.svg'"></simple-svg>
        </div>
      </template>
      <template v-else>
        <div
        ...
        >
          <simple-svg :filepath="'/static/img/sidebar/im.svg'"></simple-svg>
        </div>
        <div
        ...
        <div
          ...
          v-else
        >
          <simple-svg :filepath="'/static/img/friend-add.svg'"></simple-svg>
        </div>
        <div
          class="friends-block__actions-block"
          v-tooltip.bottom="'Разблокировать'"
          v-if="blocked || info.is_blocked || info.statusCode === 'BLOCKED'"
...
export default {
  ...
  computed: {
    ...
    statusText() {
      return this.info.is_online ? "онлайн" : "не в сети";
    },
    online() {
      return this.info.is_online;
    },
    modalText() {
      let text = "";
